...
const Home = () => {
    ...
    return (
        <div className="animate-fade-in">
            ...
            <section className="py-20">
                <div className="page-container">
                    <div className="relative overflow-hidden rounded-3xl gradient-bg p-10 sm:p-16 text-white text-center">
                        <div className="absolute inset-0" aria-hidden="true">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl" />
                            <div className="absolute bottom-0 left-0 w-64 h-64 bg-white/5 rounded-full blur-3xl" />
                        </div>
                        <div className="relative">
                            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Create Your Event?</h2>
                            <p className="text-lg text-white/80 max-w-xl mx-auto mb-8">
                                Join thousands of organizers who use EventHub to reach their audience and sell tickets effortlessly.
                            </p>
                            <Link
                                to="/register"
                                className="inline-flex items-center gap-2 bg-white text-primary-700 font-bold px-8 py-4 rounded-xl hover:shadow-xl transition-all duration-300 hover:scale-105"
                            >
                                Start for Free
                                <HiArrowRight className="w-5 h-5" />
                            </Link>
